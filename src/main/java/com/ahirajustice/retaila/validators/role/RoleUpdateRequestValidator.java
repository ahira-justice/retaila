...
public class RoleUpdateRequestValidator extends AbstractValidator<RoleUpdateRequest> {

    @Override
    public void rules() {
        ruleFor(RoleUpdateRequest::getName)
        ...
        ruleFor(RoleUpdateRequest::getPermissionIds)
